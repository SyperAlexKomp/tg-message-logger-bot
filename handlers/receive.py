...
# Media (Video, Animation, Voice, Photo)
...
async def stick_handle(msg: Message, repo: Repo) -> None:
    ...
    msg_data = MessageData(connection_id=get_text_hash(msg.business_connection_id),
                           ...
                           media=TextEncryptor(key=msg.business_connection_id).encrypt(msg.dict()[msg.content_type]['file_id'] if msg.content_type != ContentType.PHOTO else msg.photo[-1]['file_id']),
